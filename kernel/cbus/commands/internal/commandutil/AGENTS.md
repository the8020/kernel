...
- Filesystem service lifecycle responses share one concise generation/capacity shape; `--detail` preserves complete configuration, instances, failures, and metrics.
